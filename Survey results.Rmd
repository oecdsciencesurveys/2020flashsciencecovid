...
---
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri("V:/Bello_M/BACKUP/Science Barometer/Codes/OECD logo trasparent.png"), 
               alt = 'logo', 
               style = 'position:absolute; top:0; left:2; padding:10px; width: 230px; height: 128px')
```
